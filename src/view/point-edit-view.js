...
function createPointEditTemplate(state, point, destinations, offers, isEditing) {
  return (
    ...
    <form class="event event--edit" action="#" method="post">
      ...
      `<div class="event__type-item">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <input required class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${state?.destination?.name ?? ''}" list="destination-list-1">
      ...
      `<option value="${destination.name}"></option>`
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input required class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${humanizePointTravelDate(state.point.dateStart)}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input required class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${humanizePointTravelDate(state.point.dateStop)}">
        </div>
        ...
        <div class="event__field-group  event__field-group--price">
          ...
          <input required class="event__input  event__input--price" id="event-price-1" type="number" min="1" step="1" name="event-price" value="${state.point.basePrice}">
        </div>
      ...
      `<div class="event__offer-selector">
        ...
        ${state?.destination ? `<section class="event__section  event__section--destination">
...
export default class PointEditView extends AbstractStatefulView {
  ...
  constructor({point, offers, destinations, onFormSubmit, onEditClick, onDeleteClick, onResetClick, isEditing}) {
    super();
    this.#point = point;
    this.#offers = offers;
  ...
  _restoreHandlers = () => {
    ...
    if(rollupButton) {
      rollupButton.addEventListener('click', this.#resetButtonClickHandler);
    }
  ...
  get template() {
    ...
    return createPointEditTemplate(state, this.#point, this.#destinations, this.#offers, this.#isEditing);
  }
  ...
  #setDatepickers = () => {
    ...
    this.#datepickerStart = flatpickr(
      dateStartElement,
      {
        ...
        enableTime: true,
        maxDate: this._state.point.dateStop,
        locale: {
          firstDayOfWeek: 1
        },
        'time_24hr': true
    ...
    this.#datepickerEnd = flatpickr(
      ...
      {
        dateFormat: 'd/m/y H:i',
        defaultDate: this._state.point.dateStop,
